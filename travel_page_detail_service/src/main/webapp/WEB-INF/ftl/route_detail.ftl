...
<div id="header">
    ...
    <div class="wrap">
        <div class="bread_box">
            <a href="/">首页</a>
            <span> &gt;</span>
            <a href="#">${tabCategory.cname}</a><span> &gt;</span>
            <a href="#">${tabRoute.rname}</a>
        </div>
        <div class="prosum_box">
            ...
            <div class="prosum_right">
               <p class="pros_title">${tabRoute.rname}</p>
                <p class="hot">${tabRoute.routeintroduce}</p>
                <div class="pros_other">
                    <p>经营商家  ：${tabSeller.sname}</p>
                    <p>咨询电话 : ${tabSeller.consphone}</p>
                    <p>地址 ： ${tabSeller.address}</p>
                </div>
                <div class="pros_price">
                    <p class="price"><strong>¥${tabRoute.price}元</strong><span>起</span></p>
                    <p class="collect">
                        <a class="btn"><i class="glyphicon glyphicon-heart-empty"></i>点击收藏</a>

                        <a  class="btn already" disabled="disabled"><i class="glyphicon glyphicon-heart-empty"></i>点击收藏</a>
                        <span>已收藏${favoriteCount}次</span>
                    </p>
                </div>        
            </div>
        </div>
